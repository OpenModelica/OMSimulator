...
oms_addConnector("model.tlmsignals.wc1.y",output,oms_signal_type_real);
oms_addConnector("model.tlmsignals.wc1.u",input,oms_signal_type_real);
...
oms_addConnector("model.tlmsignals.wc2.y",output,oms_signal_type_real);
oms_addConnector("model.tlmsignals.wc2.u",input,oms_signal_type_real);
