...
oms_addConnector("model.tlm1d.wc1.x",oms_causality_output,oms_signal_type_real);
oms_addConnector("model.tlm1d.wc1.v",oms_causality_output,oms_signal_type_real);
oms_addConnector("model.tlm1d.wc1.f",oms_causality_input,oms_signal_type_real);
...
oms_addConnector("model.tlm1d.wc2.x",oms_causality_output,oms_signal_type_real);
oms_addConnector("model.tlm1d.wc2.v",oms_causality_output,oms_signal_type_real);
oms_addConnector("model.tlm1d.wc2.f",oms_causality_input,oms_signal_type_real);
