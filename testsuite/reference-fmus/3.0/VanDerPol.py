## status: correct
## teardown_command: rm -rf VanDerPol-cs3.mat VanDerPol-me3.mat
## linux: yes
## ucrt64: yes
## win: yes
## asan: no
...
instantiated_model.setResultFile("VanDerPol-cs3.mat")
...
if 1 == Capi.compareSimulationResults("../../references/VanDerPol-cs.mat", "VanDerPol-cs3.mat", "default.VanDerPol.x0", "default.VanDerPol.x0", 1e-4, 1e-4):
  print("signal x0 is equal", flush=True)
else:
  print("signal x0 is not equal", flush=True)


if 1 == Capi.compareSimulationResults("../../references/VanDerPol-cs.mat", "VanDerPol-cs3.mat", "default.VanDerPol.x1", "default.VanDerPol.x1", 1e-4, 1e-4):
...
model2 = SSP()
model2.addResource('../../resources/VanDerPol3.fmu', new_name='resources/VanDerPol3.fmu')

model2.addComponent(CRef('default', 'VanDerPol'), 'resources/VanDerPol3.fmu')
