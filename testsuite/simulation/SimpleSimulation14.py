## status: correct
## teardown_command: rm -rf SimpleSimulation14.ssp SimpleSimulation14_res.mat
## linux: yes
## ucrt64: yes
## win: yes
## mac: yes
...
model.export('SimpleSimulation14.ssp')

model2 = SSP('SimpleSimulation14.ssp')
model2.list()
...
instantiated_model.setResultFile("SimpleSimulation14_res.mat")
...
## info:    Result file: SimpleSimulation14_res.mat (bufferSize=10)
