-- status: correct
-- teardown_command: rm -rf deleteStartValuesInSSV2_lua/
-- linux: yes
-- ucrt64: yes
-- win: yes
-- mac: yes
...
oms_setTempDirectory("./deleteStartValuesInSSV2_lua/")
oms_setWorkingDirectory("./deleteStartValuesInSSV2_lua/")
...
oms_delete("deleteStartValuesInSSV.Root.Gain.k:start")
...
src = oms_exportSnapshot("deleteStartValuesInSSV:resources/gain.ssv")
print(src)
...
--         kind="output" />
--       <oms:Variable
--         name="deleteStartValuesInSSV.Root.Gain.u"
--         type="Real"
--         kind="input" />
--       <oms:Variable
--         name="deleteStartValuesInSSV.Root.Gain.y"
--         type="Real"
--         kind="output" />
--       <oms:Variable
--         name="deleteStartValuesInSSV.Root.Gain.k"
--         type="Real"
--         kind="parameter" />
--       <oms:Variable
