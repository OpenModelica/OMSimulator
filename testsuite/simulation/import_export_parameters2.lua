...
oms_setResultFile("import_export_parameters", "import_export_parameters2.mat", 100)
...
--             <oms:Annotations>
--               <oms:SimulationInformation
--                 resultFile="import_export_parameters2.mat"
...
-- info:    Result file: import_export_parameters2.mat (bufferSize=100)
-- info:    Initialization
