## status: correct
## teardown_command: rm -rf replacesubmodel_07_py/
## linux: no
## mingw32: no
## mingw64: yes
## win: no
...
oms.setResultFile("model", "replaceSubmodel7.mat")
...
oms.export("model", "replaceSubmodel7.ssp")
oms.terminate("model")
oms.delete("model")
...
##             <oms:Annotations>
##               <oms:SimulationInformation
##                 resultFile="replaceSubmodel7.mat"
...
##   </oms:file>
## </oms:snapshot>
## info:    Result file: replaceSubmodel7.mat (bufferSize=1)
##
