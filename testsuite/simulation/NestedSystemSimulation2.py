...
model.setSolver(CRef('default', 'sub-system1', 'Gain1'), 'solver2')
model.setSolver(CRef('default', 'sub-system1', 'Add1'), 'solver2')

model.export('NestedSystemSimulation2.ssp')

model2 = SSP('NestedSystemSimulation2.ssp')
model2.list()
