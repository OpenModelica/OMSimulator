...
oms_setTempDirectory("./import_export_parameters_01_lua/")

oms_importFile("../resources/import_export_parameters1.ssp");
...
oms_setResultFile("import_export_parameters", "import_export_parameters1.mat", 100)
...
--             <oms:Annotations>
--               <oms:SimulationInformation
--                 resultFile="import_export_parameters1.mat"
...
--   </oms:file>
--   <oms:file
--     name="resources/import_export_parameters.ssv">
--     <ssv:ParameterSet
--       xmlns:ssc="http://ssp-standard.org/SSP1/SystemStructureCommon"
--       xmlns:ssv="http://ssp-standard.org/SSP1/SystemStructureParameterValues"
--       version="1.0"
