...
/*            ( A guess; no known machine ) */
    ...
    lemin = lmax(ngpmin,ngnmin);
/*            ( Twos-complement machines, no gradual underflow; */
/*              e.g., CYBER 205 ) */
      } else {
    lemin = lmin(ngpmin,ngnmin);
/*            ( A guess; no known machine ) */
    iwarn = TRUE_;
      }
     ...
     {
      if (gpmin - lmin(ngpmin,ngnmin) == 3) {
    lemin = lmax(ngpmin,ngnmin) - 1 + lt;
...
/* Computing MIN */
      i__1 = lmin(ngpmin,ngnmin), i__1 = lmin(i__1,gpmin);
      lemin = lmin(i__1,gnmin);
/*         ( A guess; no known machine ) */
      iwarn = TRUE_;
  }
  first = FALSE_;
