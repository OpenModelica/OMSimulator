...
#define MODEL_IDENTIFIER EventTest
#define MODEL_GUID "{2e209521-b55c-45ae-980d-418d0e87300b}"
...
#define FMI2_FUNCTION_PREFIX EventTest_
...
extern void EventTest_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc EventTest_setupDataStruc
