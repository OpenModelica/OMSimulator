...
/*
FMI2_Export fmi2Status fmi2SetInterpolatedRealCallback(fmi2Component c, fmi2ValueReference vr, fmi2GetTLMEffort_ft cb)
{
  return fmi_set_interpolated_real_callback(c, vr, cb);
}

FMI2_Export fmi2Status fmi2SetTimeStampedRealCallback(fmi2Component c, fmi2ValueReference vr, fmi2SetTLMFlow_ft cb)
{
  return fmi_set_time_stamped_real_callback(c, vr, cb);
}
*/
#endif
