...
cmake -G %OMS_VS_VERSION% ..\.. -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DFMILIB_INSTALL_PREFIX=..\..\install\win -DFMILIB_BUILD_TESTS:BOOL="0" -DFMILIB_GENERATE_DOXYGEN_DOC:BOOL="0" -DFMILIB_BUILD_STATIC_LIB:BOOL="1" -DFMILIB_BUILD_SHARED_LIB:Bool="0" -DBUILD_TESTING:BOOL="0" -DFMILIB_BUILD_BEFORE_TESTS:BOOL="0" -DCMAKE_EXPORT_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_SYSTEM_PACKAGE_REGISTRY
CD ..\..\..\..
ECHO # build fmil
...
cmake -G %OMS_VS_VERSION% ..\.. -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DCMAKE_INSTALL_PREFIX=..\..\install\win -DEXAMPLES_ENABLE:BOOL="0" -DBUILD_SHARED_LIBS:BOOL="0" -DCMAKE_EXPORT_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_SYSTEM_PACKAGE_REGISTRY
CD ..\..\..\..
ECHO # build cvode
...
cmake -G %OMS_VS_VERSION% ..\..\gflags -DCMAKE_INSTALL_PREFIX=..\..\install\win -DBUILD_TESTING="OFF" -DCMAKE_BUILD_TYPE=%CMAKE_BUILD_TYPE% -DCMAKE_EXPORT_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_SYSTEM_PACKAGE_REGISTRY
CD ..\..\..\..
ECHO # build gflags
...
cmake -G %OMS_VS_VERSION% ..\..\glog -DCMAKE_INSTALL_PREFIX=..\..\install\win -DBUILD_TESTING="OFF" -DCMAKE_BUILD_TYPE=%CMAKE_BUILD_TYPE% -DCMAKE_EXPORT_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_SYSTEM_PACKAGE_REGISTRY
CD ..\..\..\..
ECHO # build glog
...
MKDIR build\win
CD build\win
cmake -G %OMS_VS_VERSION% ..\.. -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DOMFIT="ON" -DBOOST_ROOT=%BOOST_ROOT% -DCMAKE_BUILD_TYPE=%CMAKE_BUILD_TYPE% -DCMAKE_EXPORT_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY -DCMAKE_FIND_PACKAGE_NO_SYSTEM_PACKAGE_REGISTRY
CD ..\..\
:: -- config OMSimulator ------------------------------------------------------
