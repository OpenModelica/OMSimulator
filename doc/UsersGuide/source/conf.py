...
project = u'OMSimulator'
copyright = u'2017, Lennart Ochel'
...
latex_documents = [
  ('index', 'OMSimulator.tex', u'OMSimulator Documentation',
   u'Lennart Ochel', 'manual'),
]
...
man_pages = [
    ('index', 'OMSimulator', u'OMSimulator Documentation',
     [u'Lennart Ochel'], 1)
]
...
texinfo_documents = [
  ('index', 'OMSimulator', u'OMSimulator Documentation',
   u'Lennart Ochel', 'OMSimulator', 'One line description of project.',
   'Miscellaneous'),
]
