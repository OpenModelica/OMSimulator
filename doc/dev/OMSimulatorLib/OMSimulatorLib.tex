...
\begin{tikzpicture}
  \begin{umlpackage}{OMSimulatorLib}
    ...
    \umlclass[x=-1.5, y=5.5]{Model}{
      - geometry: ssd:SystemGeometry \\
      - startTime: double \\
      - stopTime: double \\
      - resultFile: string
    }{
  ...
  \umlnote[x=7,y=11.5, width=3cm]{Scope}{Global scope}
  \umlnote[x=-12,y=12.5, width=3cm]{OMSimulatorLib}{namespace oms2}
\end{tikzpicture}
