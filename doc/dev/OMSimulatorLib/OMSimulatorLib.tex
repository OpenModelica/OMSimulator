...
\begin{tikzpicture}
  \begin{umlpackage}{OMSimulatorLib}
    \umlclass[x=-1.5, y=7]{Scope}{
      - models: map<ComRef,Model> \\
      - tempDir: string
    }{
      + newFMIModel() \\
      + newTLMModel() \\
    ...
    \umlclass[x=-1.5, y=0.5, fill=ucl2orange]{Model}{
      - name: ComRef \\
    ...
    \umlclass[x=-13, y=-6]{ExternalModel}{}{}
    ...
    \umlclass[x=22, y=0.5]{FMUWrapperME}{}{}
    \umlclass[x=22, y=-3.5]{FMUWrapperCS}{}{}
  \end{umlpackage}
  ...
  \umlinherit[geometry=--]{FMICompositeModel}{Model}
  \umlinherit[geometry=--]{TLMCompositeModel}{Model}
  ...
  \umlinherit[geometry=--]{FMUWrapperME}{FMUWrapper}
  \umlinherit[geometry=--]{FMUWrapperCS}{FMUWrapper}

  \umlnote[x=7,y=7, width=3cm]{Scope}{Global scope}
  \umlnote[x=-12,y=8.5, width=3cm]{OMSimulatorLib}{namespace oms2}
\end{tikzpicture}
