...
OMSAPI oms_status_enu_t OMSCALL oms_exportSnapshot(const char* ex_cref, char** contents);
...
OMSAPI oms_status_enu_t OMSCALL oms_importSnapshot(const char* ex_cref, const char* snapshot);
