...
OMSAPI oms_status_enu_t OMSCALL oms_freeMemory(void* obj);
...
OMSAPI oms_status_enu_t OMSCALL oms_setSolver(const char* cref, const char* solver);
...
OMSAPI oms_status_enu_t OMSCALL oms_setTolerance(const char* cref, double tolerance);
