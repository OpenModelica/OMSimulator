...
oms_status_enu_t oms3_listModel(const char* ident, char** contents);
oms_status_enu_t oms3_parseModelName(const char* contents, char** ident);
oms_status_enu_t oms3_importString(const char* contents, char** ident);
...
oms_status_enu_t oms3_getElement(const char* cref, oms_element_t** element);
